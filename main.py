...
tf.app.flags.DEFINE_string('year', '2014', 'year of the semeval dataset')
tf.app.flags.DEFINE_string('domain', 'rest', 'domain of the data, restaurant or laptop')
tf.app.flags.DEFINE_string('embedding', 'glove', 'embedding dictionary, glove or word2vec')
